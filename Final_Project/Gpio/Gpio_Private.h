...
//#define SYSCFG_MEMRMP  (*(uint32 *)(SYSCFG_BASE_ADDRESS + 0x00))
//#define SYSCFG_EXTICR1 (*(uint32 *)(SYSCFG_BASE_ADDRESS + 0x08))
//#define SYSCFG_EXTICR2 (*(uint32 *)(SYSCFG_BASE_ADDRESS + 0x0C))
//#define SYSCFG_EXTICR3 (*(uint32 *)(SYSCFG_BASE_ADDRESS + 0x10))
//#define SYSCFG_EXTICR4 (*(uint32 *)(SYSCFG_BASE_ADDRESS + 0x14))
//#define SYSCFG_CMPCR   (*(uint32 *)(SYSCFG_BASE_ADDRESS + 0x20))
